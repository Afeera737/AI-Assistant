...
def demo_response(system_msg: str, user_input: str) -> str:
    ...
    # Summarizer heuristic: split into sentences and return top 3 bullets
    ...
    # Flashcards heuristic: create Q/A from sentences
    ...
    # MCQs heuristic: deterministic sample MCQs based on words
    ...
    # Default chat: echo the first two sentences concisely
    sents = re.split(r'(?<=[.!?])\s+', text)
...
def generate_response(system_msg: str, user_input: str) -> str:
    ...
    if llm:
        try:
            ...
            # fallback to demo but also surface a short note
